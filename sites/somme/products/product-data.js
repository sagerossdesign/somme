...
export const products = {
  sensual: {
    ...
    product: {
      ...
      imageSrc: '../assets/images/products/sensual-tsp.png',
  ...
  sovereign: {
    ...
    product: {
      ...
      imageSrc: '../assets/images/products/sovereign-tsp.png',
  ...
  steady: {
    ...
    product: {
      ...
      imageSrc: '../assets/images/products/steady-tsp.png',
...
export const buildProductPageConfig = (slug) => {
  ...
  return {
    ...
    navigation: {
      ...
      homeLabel: 'sōmme',
      links: [
        { href: '../index.html#tea', label: 'tea' },
        { href: '../about.html', label: 'about' },
      ],
      previous: {
        href: `./${previousSlug}.html`,
        label: previousSlug,
      },
      next: {
        href: `./${nextSlug}.html`,
